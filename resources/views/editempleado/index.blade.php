                    ...
                    <form method="POST" action="{{ route('updatempleado.update', $empleado->id) }}">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input type="time" id="horaevento" placeholder="Seleccionar hora"  rows="4" class="mt-1 p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black" required min="07:00" max="18:00">
